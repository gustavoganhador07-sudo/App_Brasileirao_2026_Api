...
def listar_Cadastros():
    ...
    dados = [
        {"idSerieD": row[0], "NomeClube": row[1], "PontosClube": row[2], "JogosClube": row[3], "SaldosGols": row[4], "VitoriasClube": row[5],"EmpateClube": row[7], "DerrotasClube": row[6],  "PosicaoClube": row[8]}
